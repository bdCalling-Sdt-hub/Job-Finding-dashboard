...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <div className="w-full px-5 py-3.5 bg-[#e0f6d7] flex justify-between items-center text-white sticky top-0 left-0 z-10 border-b-2 border-[#9a4ed4]">
      ...
      <div className="flex justify-between items-center gap-5">
        <Link to={"/notification"}>
          <h1 className="relative text-[#7ed957] p-2 rounded-full ">
