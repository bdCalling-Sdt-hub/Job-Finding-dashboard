...
const CareerResourcesMainNetworkEventEdit = () => {
    const uploadProps = {
        name: "file",
        multiple: true,
    ...
    return (
        <div className="bg-white p-6 rounded shadow-sm   mx-auto">
            ...
            >
                ...
                <h1 className="text-2xl font-semibold">Edit Networking Event </h1>
            </Link>
...
export default CareerResourcesMainNetworkEventEdit;
